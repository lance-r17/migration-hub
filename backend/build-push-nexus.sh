...
# ------------------------------------------------------------------------------
# Build and push backend Docker image to a Nexus Docker registry.
...
Environment file variables:
  ...
  RUNTIME_IMAGE         Runtime base image (default: python:3.12-slim)
  ...
  IMAGE_NAME            Image name component (default: backend)
