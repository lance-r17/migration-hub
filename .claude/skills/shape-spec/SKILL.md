---
name: shape-spec
description: Gather context and structure planning for significant feature work. Use when the user wants to (1) shape a specification or plan for a new feature or change, (2) plan significant implementation work across multiple tasks, (3) create a dated spec folder in agent-os/specs/, (4) structure multi-task development work before coding begins, or (5) run a structured planning session. Must run in plan mode. Produces spec documentation including plan.md, shape.md, standards.md, references.md, and visuals/.
---
