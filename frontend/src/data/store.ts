...
let _migrationSettings: MigrationSettings = { platformPeriod: undefined, cloudSetupPeriod: { startDate: '2026-04-01', endDate: '2026-12-12' }, durationOptions: [15, 30, 45] }
...
export const store = {
  ...
  getMigrationSettings(): MigrationSettings {
