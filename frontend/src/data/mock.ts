  ...
  groups: [
    {
      ...
      questions: [
        ...
        {
          id: 'db__incremental_migration_date_range',
          specsKey: 'incremental_migration_start_date',
          toSpecsKey: 'incremental_migration_end_date',
          label: 'Incremental migration date range',
          hintText: 'Select the start and end dates for incremental replication',
