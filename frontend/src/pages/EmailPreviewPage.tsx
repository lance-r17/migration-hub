...
const SAMPLE_DATA_SETS: { label: string; data: SampleData }[] = [
  {
    ...
    data: {
      ...
      'daysUntilCutover': '14',
      'milestone.name': 'Data Migration (Dev)',
      'milestone.statusLabel': 'In Progress',
      'milestone.targetDate': '2026-06-16',
      'milestone.targetLabel': 'end date',
      'milestone.dueLabel': 'in 14 days',
      'daysUntil': '14',
  ...
  },
  {
    ...
    data: {
      ...
      'daysUntilCutover': '7',
      'milestone.name': 'PRD Resource Provision Stage',
      'milestone.statusLabel': 'To Do',
      'milestone.targetDate': '2026-03-24',
      'milestone.targetLabel': 'start date',
      'milestone.dueLabel': 'in 7 days',
      'daysUntil': '7',
  ...
  },
  {
    ...
    data: {
      ...
      'daysUntilCutover': '3',
      'milestone.name': 'PRD Cutover',
      'milestone.statusLabel': 'To Do',
      'milestone.targetDate': '2026-04-12',
      'milestone.targetLabel': 'start date',
      'milestone.dueLabel': 'in 3 days',
      'daysUntil': '3',
