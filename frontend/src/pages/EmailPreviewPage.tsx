...
const SAMPLE_DATA_SETS: { label: string; data: SampleData }[] = [
  {
    ...
    data: {
      ...
      'jiraTicket.key': 'MIG-101',
      'jiraTicket.url': 'https://jira.company.com/browse/MIG-101',
      ...
      'project.currentInfrastructure.resources': [
        { name: 'web-server-01', product: 'ecs',     category: 'VM',       jiraSubtaskKey: 'MIG-102', syncStatus: 'synced' },
        { name: 'main-database', product: 'polarDB', category: 'Database', jiraSubtaskKey: 'MIG-103', syncStatus: 'synced' },
        { name: 'asset-storage', product: 'oss',     category: 'Buckets',  jiraSubtaskKey: 'MIG-104', syncStatus: 'out-of-sync' },
      ],
    },
  },
  {
    ...
    data: {
      ...
      'jiraTicket.key': 'MIG-55',
      'jiraTicket.url': 'https://jira.company.com/browse/MIG-55',
      'jiraBaseUrl': 'https://jira.company.com',
      'platform.name': 'Migration Hub',
      'platform.url': 'http://localhost:5173',
      'project.currentInfrastructure.resources': [
        { name: 'api-server-01',   product: 'ecs', category: 'VM',       jiraSubtaskKey: 'MIG-56', syncStatus: 'synced' },
        { name: 'commerce-db',     product: 'rds', category: 'Database', jiraSubtaskKey: 'MIG-57', syncStatus: 'synced' },
        { name: 'product-images',  product: 'oss', category: 'Buckets',  jiraSubtaskKey: 'MIG-58', syncStatus: 'synced' },
      ],
    },
  },
  {
    ...
    data: {
      ...
      'jiraTicket.key': 'MIG-82',
      'jiraTicket.url': 'https://jira.company.com/browse/MIG-82',
      'jiraBaseUrl': 'https://jira.company.com',
      'platform.name': 'Migration Hub',
      'platform.url': 'http://localhost:5173',
      'project.currentInfrastructure.resources': [
        { name: 'payment-gateway', product: 'ecs',     category: 'VM',       jiraSubtaskKey: 'MIG-83', syncStatus: 'synced' },
